...
import { AlertTriangle, X, Info, ShieldAlert, ArrowUpRight, CheckCircle2 } from "lucide-react";
  ...
  return (
    <section className="py-20 bg-white border-b border-neutral-border/60 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Modal Container */}
        <div className="max-w-xl mx-auto bg-white rounded-2xl border border-neutral-border shadow-xl overflow-hidden">
          ...
          <div className="p-5 sm:p-6 border-b border-neutral-border/60 flex items-center justify-between bg-neutral-bg/30">
            ...
            <button
              className="p-1 rounded-md text-neutral-text/40 hover:text-neutral-text/80 hover:bg-neutral-border/40 transition-colors"
